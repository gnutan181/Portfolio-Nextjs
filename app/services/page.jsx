...
const services =[
  {
    ...
    description:'Passionate web developer with 1+ years of experiences',
    href:""
  },
  {
    num:'02',
...
const Services = () => {
  ...
  {services.map((service,index)=>{
    return( <div key={index} className="flex-1 flex flex-col justify-center gap-6 group">
      ...
      className="w-[70px] h-[70px] rounded-full bg-white group-hover:bg-accent active:bg-accent transition-all duration-500 flex justify-center items-center hover:-rotate-45">
