            ...
            return (
              <div
                ...
                className={`flex-1 flex flex-col justify-center gap-6 group ${
                  activeIndex === index ? "group-hover" : ""
                }`}
                onTouchStart={() => setActiveIndex(index)} // Set active index on touch
                onTouchEnd={() => setActiveIndex(null)} // Reset active index on touch end
              >
